...
{	
	...
	{
		[self setDelegate:(id<SBSourceListDelegate>)[super delegate]];
		[super setDelegate:self];
		
		[self setDataSource:(id<SBSourceListDataSource>)[super dataSource]];
...
- (void)setDelegate:(id<SBSourceListDelegate>)aDelegate
{
...
- (void)setDataSource:(id<SBSourceListDataSource>)aDataSource
{
...
- (void)reloadData
{
	...
	if([_secondaryDataSource conformsToProtocol:@protocol(SBSourceListDataSource)] &&
...
- (NSMenu *)menuForEvent:(NSEvent *)theEvent
{
	...
	if([_secondaryDelegate respondsToSelector:@selector(sourceList:menuForEvent:item:)]) {
        ...
        // force clicked row to be selected
        if (row >= 0)
